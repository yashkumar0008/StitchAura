  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <Card
          icon={FaUser}
          text="Save/Update your profile to find the best tailors near you."
          button="Your Profile"
        ...
        <Card
          icon={FaSearch}
          text="Browse and connect with skilled tailors in your city."
          button="Find Tailors"
          onClick={() => navigate("/customer-find-tailor")}
        />

        {/* Rating */}
        <Card
          icon={FaStar}
          text="Share your experience to help others choose the right tailor."
          button="Give Rating"
          onClick={() => navigate("/customer-rating")}
        />
